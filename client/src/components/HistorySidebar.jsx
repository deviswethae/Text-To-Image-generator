...
const HistorySidebar = ({ onSelectHistory }) => {
  ...
  const fetchHistory = async () => {
    try {
      setLoading(true);
      const response = await axios.get('https://text-to-image-generator-vhyy.onrender.com/api/history');
  ...
  const clearHistory = async () => {
    try {
      await axios.delete('https://text-to-image-generator-vhyy.onrender.com/api/history');
      setHistory([]);
    } catch (error) {
